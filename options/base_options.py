...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='sen2w_resnet2222', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--gpu_ids', type=str, default='3', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--model', type=str, default='INRECGAN', help='which model to use')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/home/hnu/cfiles/ly/datasets/sen1-2_data_2w/')
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='INRs', help='selects model to use for netG')
        self.parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
        self.parser.add_argument('--n_downsample', type=int, default=4, help='number of downsampling layers in netG')
